...
int main(int argc, char* argv []){
  ...
  Kokkos::initialize( argc, argv );
  {
    ...
    Kokkos::parallel_for("InitDistFunc", Kokkos::MDRangePolicy<Kokkos::Rank<6>>({0,0,0,0,0,0}, {N_x[0], N_x[1], N_x[2], N_v[0], N_v[1], N_v[2]}),KOKKOS_LAMBDA(size_t i, size_t j, size_t k, size_t l, size_t m, size_t n){
